...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginView = __webpack_require__(166);
	...
	var Wrapper = function (_React$Component) {
	  ...
	  function Wrapper(props) {
	    ...
	    _this.state = {
	      activeView: _loginView2.default,
	      activeViewState: {}
	    };
	    return _this;
	  }
	  ...
	  _createClass(Wrapper, [{
	    key: 'setActiveView',
	    value: function setActiveView(activeView, state) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(ActiveView, { setActiveView: this.setActiveView, activeViewState: this.state.activeViewState })
	      );
	    }
	  }]);
